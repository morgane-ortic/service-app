...
load_dotenv(dotenv_path=str(BASE_DIR / 'db.env'))
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    '6009-2a04-4540-7014-bd00-45c3-ecfe-8df-e5bf.ngrok-free.app',  # Exact ngrok domain
    '.ngrok-free.app',  # Wildcard for any ngrok domain
]


CSRF_TRUSTED_ORIGINS = ['https://6009-2a04-4540-7014-bd00-45c3-ecfe-8df-e5bf.ngrok-free.app']
...
ROOT_URLCONF = 'massageservice.urls'
...
WSGI_APPLICATION = 'massageservice.wsgi.application'
...
# Used to access css file directly in the static folder
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
